...
* 'user_goals': The user's short-term and long-term professional and personal ambitions.
...
* 'user_mindset': The user's attitude towards risk, learning, and growth (e.g., risk-averse, growth-oriented).
...
2.  **FORMULATE STRATEGIC SEARCH QUERIES:**
    ...
    * **Query Formulation Strategy:**
        ...
        * **Address challenges:** `how to overcome 'user_challenges' for aspiring entrepreneurs`, `online courses to build skills for 'user_goals'`.
...
4.  **GENERATE A PERSONALIZED OPPORTUNITY REPORT:**
    ...
    * The report should be organized into logical sections, such as:
        ...
        * **Recommended Skill Development Paths:** Suggestions for courses, certifications, or workshops to address 'user_challenges' and achieve 'user_goals'.
