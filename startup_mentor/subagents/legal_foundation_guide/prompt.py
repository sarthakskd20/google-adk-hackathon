...
- Their goals and dreams ('user_goals', 'user_startup_dream')
- Their available time and mindset ('user_available_time', 'user_mindset')
- Any challenges they're facing ('user_challenges')
- Their startup idea ('startup_idea_description')
- Where they want to start it ('planned_startup_location')
- Their business type ('business_model_concept')
...
- Permits/licenses for 'business_model_concept' in 'planned_startup_location'
...
"Hey user_name, based on your idea to build something in the 'business_model_concept' space from 'planned_startup_location', here's a breakdown of some key legal checkpoints to keep in mind. Don't worry — you don't need to be a lawyer to get this right, just aware and proactive. Let me walk you through it."

---

### Output Instructions:

1. Generate Google Search queries that will help you get recent and relevant legal information for 'planned_startup_location' and 'business_model_concept'.
